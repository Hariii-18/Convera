...
normalization/translation) or `SUMMARY_AI_PROVIDER` (for Summary generation
only — see `get_summary_ai_provider`).
...
def get_ai_provider() -> AIProvider:
    """Returns the configured provider for normalization/translation,
    constructing (and caching) it once per process.
    """
